...
fun main() {
    ...
    measureTimedValue { day02.part1() }.let { (result, time) -> println("Day02::part1 -> $result [$time]") }
    measureTimedValue { day02.part2() }.let { (result, time) -> println("Day02::part2 -> $result [$time]") }
}
